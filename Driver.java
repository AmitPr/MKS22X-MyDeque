...
public class Driver {
	 ...
	 * 
	 * 
	 * Important: this Driver is contingent on your toString already working. If
	 * your toString is broken, you may recieve confusing results.
	 * 
	 * 
	 * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * *
	 * * * * * * * * * * * * * * * * * * * * * * * *
	...
	public static void main(String[] args) {
		...
		for (int i = 0; i < 1000; i++) {
			...
			try {
				...
				if (comp.size() != deque.size()) {
					out.add(message(old + ".addLast(" + i + ")\n" + gist_string(deque) + ".size()", comp.size(),
							deque.size()));
					break;
				}
			} catch (Exception e) {
		...
		// stepping forwards -- this should place us somewhere in the middle of the data
		// array
		...
		// stepping backwards -- this should place us somewhere in the middle of the
		// data array
